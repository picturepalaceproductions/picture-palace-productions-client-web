...
class _SelectionScreenState extends State<SelectionScreen> {
  ...
  Future<void> _confirmAndSend() async {
    ...
    // ========================================
    // SEND SELECTION BY EMAILJS
    // ========================================

    final emailSent = await _sendSelectionEmail(
      ...
      await showDialog(
        ...
        builder: (context) {
          return AlertDialog(
            ...
            content: const Text(
              "Your selection has been saved successfully, but the email could not be sent.\n\nPlease try sending again.",
              style: TextStyle(
                color: Colors.white70,
                fontSize: 14,
                height: 1.5,
  ...
  //
  static const String _emailJsServiceId = "service_can6ljs";
  static const String _emailJsTemplateId = "template_svn6bf5";
  static const String _emailJsPublicKey = "p5ZqI9dmdTkk9EX7a";
  //
  // IMPORTANT:
  // EmailJS Account -> Security -> "Use Private Key" is enabled.
  // Put your CURRENT Private Key here locally.
  // Do NOT share this key publicly.
  static const String _emailJsPrivateKey = "6nkh4A6DqtboN0GwEDO_u";
  // ==========================================
  // SEND SELECTION EMAIL
  // ==========================================

  Future<bool> _sendSelectionEmail({
    required Map<String, dynamic> selectionData,
    required String selectionJson,
  }) async {
    try {
      debugPrint("========================================");
      debugPrint("EMAILJS SELECTION EMAIL");
      debugPrint("========================================");

      final submittedOn = selectionData["submittedOn"]?.toString() ?? "";

      final templateParams = {
        "client_name": widget.album.clientName,
        "album_code": widget.album.albumCode,
        "total_selected": totalSelected.toString(),
        "submitted_on": submittedOn,
        "json_data": selectionJson,

        // EmailJS template fields
        "name": widget.album.clientName,
        "email": "info.picturepalaceproductions@gmail.com",
      };
